...
public class SysAclModuleService {
    ...
    public void save(AclModuleParam param) {
        ...
        aclModule.setLevel(LeveUtil.calculateLeve(getLevel(param.getParentId()), param.getParentId()));
    ...
    public void update(AclModuleParam param) {
        ...
        SysAclModule after = SysAclModule.builder().id(param.getId()).name(param.getName()).parentId(param.getParentId()).seq(param.getSeq())
                .status(param.getStatus()).remark(param.getRemark()).build();
        after.setLevel(LeveUtil.calculateLeve(getLevel(param.getParentId()), param.getParentId()));
